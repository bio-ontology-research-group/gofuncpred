...
#Source code of EMNLP2018 paper: "Differentiating Concepts and Instances for Knowledge Graph Embedding". https://arxiv.org/abs/1811.04588
...
def parseargs():
    ...
    parsers.add_argument("--emb_dim", type=int,default=200)
    ...
    parsers.add_argument("--dataset", type=str, default="all")
